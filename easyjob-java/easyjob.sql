...
Source Database       : easyjob2

Target Server Type    : MYSQL
Target Server Version : 50739
File Encoding         : 65001

Date: 2023-10-06 16:05:18
*/
...
CREATE TABLE `app_carousel` (
  ...
  `object_type` tinyint(4) DEFAULT NULL COMMENT '0:分享1:问题 2:考题 3:外部连接',
...
CREATE TABLE `app_exam` (
  ...
  `status` tinyint(4) DEFAULT NULL COMMENT '0:未完成 1:已完成',
  `remark` varchar(150) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`exam_id`),
  KEY `idx_user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10101 DEFAULT CHARSET=utf8mb4 COMMENT='用户在线考试';
...
) ENGINE=InnoDB AUTO_INCREMENT=13604 DEFAULT CHARSET=utf8mb4 COMMENT='考试问题';
...
CREATE TABLE `app_feedback` (
  ...
  `status` tinyint(4) DEFAULT NULL COMMENT '状态0:未回复 1:已回复',
...
) ENGINE=InnoDB AUTO_INCREMENT=167 DEFAULT CHARSET=utf8mb4 COMMENT='用户收藏';
...
CREATE TABLE `exam_question` (
  ...
  `question_type` tinyint(4) DEFAULT NULL COMMENT '问题类型 0:判断 1:单选题 2:多选',
...
) ENGINE=InnoDB AUTO_INCREMENT=10051 DEFAULT CHARSET=utf8mb4 COMMENT='考试题目';
...
CREATE TABLE `question_info` (
  ...
  `post_user_type` tinyint(1) DEFAULT '0' COMMENT '0:内部 1:外部投稿',
  PRIMARY KEY (`question_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10223 DEFAULT CHARSET=utf8mb4 COMMENT='问题';
...
) ENGINE=InnoDB AUTO_INCREMENT=1000002 DEFAULT CHARSET=utf8mb4 COMMENT='账号信息';
...
CREATE TABLE `sys_menu` (
  ...
  `show_type` int(11) DEFAULT '0' COMMENT '0:可分配菜单 1:基础菜单',
...
INSERT INTO `sys_menu` VALUES ('1006', '新增/修改分类', '1', '', '1002', '2', 'category_eidt', '0', '');
